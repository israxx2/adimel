                        ...
                        <div class="col-lg-5 col-md-6 col-sm-6">
                            ...
                            <div class="product-details-left">
                                <div class="product-details-images slider-navigation-1">
                                    <div class="lg-image">
                                        <img src="{{ asset('electro/images/product/large-size/12.jpg')}}" alt="product image">
                                    </div>
                                    <div class="lg-image">
                                        <img src="{{ asset('electro/images/product/large-size/1.jpg') }}"alt="product image">
                                    </div>
                                    <div class="lg-image">
                                        <img ssrc="{{ asset('electro/images/product/large-size/1.jpg') }}" alt="product image">
                                    </div>
                                    <div class="lg-image">
                                        <img src="{{ asset('electro/images/product/large-size/1.jpg') }}" alt="product image">
                                    </div>
                                ...
                                <div class="product-details-thumbs slider-thumbs-1">
                                    <div class="sm-image"><img src="{{ asset('electro/images/product/large-size/1.jpg') }}"alt="product image thumb"></div>
                                    <div class="sm-image"><img src="{{ asset('electro/images/product/large-size/1.jpg') }}" alt="product image thumb"></div>
                                    <div class="sm-image"><img src="{{ asset('electro/images/product/large-size/1.jpg') }}" alt="product image thumb"></div>
                                    <div class="sm-image"><img src="{{ asset('electro/images/product/large-size/1.jpg') }}" alt="product image thumb"></div>
                                    <div class="sm-image"><img src="{{ asset('electro/images/product/large-size/1.jpg') }}" alt="product image thumb"></div>
