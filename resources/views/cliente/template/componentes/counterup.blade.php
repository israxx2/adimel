        ...
        <div class="row no-gutters">
                ...
                <div class="limupa-counter white-smoke-bg">
                    <div class="container">
                        <div class="counter-img">
                            <img src="{{ asset('electro/images/about-us/icon/1.png') }}" alt="">
                        </div>
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <div class="limupa-counter gray-bg">
                    <div class="counter-img">
                        <img src="{{ asset('electro/images/about-us/icon/2.png') }}" alt="">
                    </div>
                    <div class="counter-info">
                        <div class="counter-number">
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <div class="limupa-counter white-smoke-bg">
                    <div class="counter-img">
                        <img src="{{ asset('electro/images/about-us/icon/3.png') }}" alt="">
                    </div>
                    <div class="counter-info">
                        <div class="counter-number">
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <div class="limupa-counter gray-bg">
                    <div class="counter-img">
                        <img src="{{ asset('electro/images/about-us/icon/4.png') }}" alt="">
                    </div>
                    <div class="counter-info">
                        <div class="counter-number">
                            <h3 class="counter">2169</h3>
